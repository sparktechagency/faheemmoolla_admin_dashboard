...
import { Avatar, Badge, Button, Card, Input, Spin, Tag, message, Popconfirm } from "antd";
import { BellOutlined, CheckCircleOutlined, DeleteOutlined, CloseOutlined } from "@ant-design/icons";
                    ...
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <div className="flex items-center">
                        ...
                        <Popconfirm
                          ...
                          onConfirm={(e) => {
                            e.stopPropagation();
                            handleDeleteSingleNotification(notif._id, e);
                          }}
