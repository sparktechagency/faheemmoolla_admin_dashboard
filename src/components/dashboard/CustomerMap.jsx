...
const CustomerMap = () => {
  ...
  if (queryError) {
    return (
      <section className="w-full lg:w-7/12 p-2 rounded-[10px] border border-primary">
    ...
    <section className="w-full lg:w-4/12 p-2 rounded-[10px] border border-primary">
      <Card className="w-full">
        <div className="flex flex-col items-start justify-between mb-4 sm:flex-row sm:items-center">
          <h3 className="m-0 text-xl font-bold md:text-2xl">
          Customer Map
          </h3>
        ...
        {queryLoading ? (
          ...
          <div className="w-full h-64 md:h-72 lg:h-[343px]">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={mappedData} margin={{ top: 5, right: 5, left: 0, bottom: 10 }}>
